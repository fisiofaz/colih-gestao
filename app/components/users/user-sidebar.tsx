...
export default function UserSidebar({ counts }: UserSidebarProps) {
  ...
  const menuItems = [
    { label: "Todos", role: null, count: counts.total, icon: "👥" },
    { label: "COLIH", role: "COLIH", count: counts.COLIH, icon: "👔" },
    { label: "GVP", role: "GVP", count: counts.GVP, icon: "🏥" },
    // Opcional: Mostrar Admins também
    {
